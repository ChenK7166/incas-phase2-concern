...
CONCERN_DICT = {
    "us military": "Concern/US Military",
    "international relations": "Concern/International Relations",
    "domestic political issues": "Concern/Domestic Political Issues",
    "defense and military": "Concern/Defense and Military",
    "insurgent threats": "Concern/Insurgent Threats",
    "social and economic issues": "Concern/Social and Economic Issues",
    "public services": "Concern/Public Services",
    "environmental issues": "Concern/Environmental Issues",
    "energy": "Concern/Energy",
    "labor and migration": "Concern/Labor and Migration",
    "crime": "Concern/Crime",
...
if __name__ == "__main__":
    ...
    with open('concern_annotate_{}.jsonl'.format(args.file), 'w') as json_file:
